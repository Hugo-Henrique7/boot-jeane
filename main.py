...
#Setando as aparencias padrões do sistema
...
class App(ctk.CTk):
  ...
  def layout_config(self):
    self.title("Sistema de gestão de clientes EPI")
  ...
  def todo_sistema(self):
    ...
    title = ctk.CTkLabel(frame, text="Sistema de Gestão de Clientes EPI", font=("Centry Gothic bold", 24), text_color="#fff").place(x=190, y=10)

    span = ctk.CTkLabel(self, text="Por favor, preencha todos os campos do formulário", font=("Centry Gothic bold", 16), text_color=["#000", "#fff"]).place(x=50, y=70)
    ...
    lb_address = ctk.CTkLabel(self, text="Endereço", font=("Centruy Gothic bold", 16), text_color=["#000", "#fff"])
    lb_obs = ctk.CTkLabel(self, text="Observações", font=("Century Gothic bold", 16), text_color=["#000", "#fff"])

    #Botões
    btn_subimit = ctk.CTkButton(self, text="Salvar Dados".upper(), command=submit, fg_color="#151", hover_color="#131").place(x=300, y=420)
